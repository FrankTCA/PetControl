                    ...
                    if (tamableAnimal.isTame()) {
                        ...
                        if (ownerUUID != null) {
                            ...
                            if (rae != null)
                                roaming = true;
                            if (tae == null) {
                                tae = new TamedAnimalEntry(PetControl.cacheManager.getAnimalTypeFromEntity(playerFacing), playerFacing.getUniqueId(), ownerUUID, playerFacing.getName(), Bukkit.getOfflinePlayer(ownerUUID).getName(), tamableAnimal.isOrderedToSit(), false, roaming);
                                PetControl.cacheManager.addTamedAnimalEntry(tae);
                            } else {
                                tae = new TamedAnimalEntry(PetControl.cacheManager.getAnimalTypeFromEntity(playerFacing), playerFacing.getUniqueId(), ownerUUID, playerFacing.getName(), Bukkit.getOfflinePlayer(ownerUUID).getName(), tamableAnimal.isOrderedToSit(), tae.isGuarded(), roaming);
